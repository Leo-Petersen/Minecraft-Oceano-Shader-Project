...
#include "/world1/lib/voxel_settings.glsl"
...
#include "/world1/lib/lighting.glsl"
#include "/world1/lib/brdf.glsl"
#include "/world1/lib/raytrace.glsl"
#include "/world1/lib/handlight.glsl"
#include "/world1/lib/waterBump.glsl"
#include "/world1/lib/caustics.glsl"
...
void main() {
    ...
    //// Apply Lighting ////
        ...
        vec3 warmShadowDist = mix(shadowDistColor, sunlightCol * 0.4,0) * mix(0.5, 1.0, transitionFade);
        finalAmbient = mix(finalAmbient, mix(finalAmbient, warmShadowDist * 2.5, distShadowMask), 0);
